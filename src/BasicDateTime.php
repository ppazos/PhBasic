...
class BasicDateTime {
  ...
  const HUMAN_DATETME_FORMAT = 'M j, Y H:i'; 
  ...
  // UI DateTime:
  // transforms the datetime into client TZ
  // then formats in the HUMAN_DATETME_FORMAT
  static function uidt ($datetime)
  {
    return date(self::HUMAN_DATETME_FORMAT, strtotime(self::get_client_date_time($datetime)));
  }
}
?>
